          ...
          <View style={styles.whitebox}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10 }}>
              ...
              <Text style={[styles.h6, {
                color: item.cleaning_status === 'In Progress'
                  ? '#FFC003'
                  : item.cleaning_status === 'Completed'
                    ? '#008B06'
                    : '#FE0000',
...
const Completed = () => {
  ...
  // Filter bookings where cleaning_status is "Completed"
  const completedBookings = userbooking.filter(booking => booking.cleaning_status === 'Completed');
